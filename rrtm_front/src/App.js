...
import LoginPage from "./pages/InterfacciaUtenteNonLoggato/loginPage/LoginPage";
    ...
    return (
        <Router>
            <Routes>
                ...
                <Route
                    path="/ResultFindPage/:name"
                    element={<ResultFindPage />}
                />
                ...
                />
                <Route
                    path="/StrategiaPage/:strategiaId"
                    element={<StrategiaPage />}
                />
                <Route
                    path="/VulnerabilitaPage/:vulnerabilitaId"
                    element={<VulnerabilitaPage />}
                />
                <Route
                    path="/ArticoloPage/:articoloId"
                    element={<ArticoloPage />}
                />
                ...
                <Route
                    path="/inserimentoFeedbackUt"
                    element={<InserimentoFeedbackPage />}
                />
                <Route
                    path="/inserimentoVulnerabilitaUt"
                    element={<InserimentoVulnerabilitaPage />}
                />
                <Route
                    path="/visualizzaVulnerabilitaUt"
                    element={<VulnerabilitaSegnalatePage />}
                />
                <Route
                    path="/visualizzaFeedback"
                    element={<VisualizzaFeedbackPage />}
                />
                <Route path="/NotifichePage" element={<NotifichePage />} />
                <Route
                    path="/InserimentoNotifichePage"
                    element={<InserimentoNotifichePage />}
                />
